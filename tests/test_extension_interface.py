...
class CAPITests(unittest.TestCase):
    def test_switch(self):
        self.assertEqual(
            50, _test_extension.test_switch(greenstack.greenlet(lambda: 50)))
    ...
    def test_raise_greenlet_dead(self):
        self.assertRaises(
            greenstack.GreenletExit, _test_extension.test_raise_dead_greenlet)

    def test_raise_greenlet_error(self):
        self.assertRaises(
            greenstack.error, _test_extension.test_raise_greenlet_error)
